...
class CashflowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cashflow" do
    assert_difference('Cashflow.count') do
      post cashflows_url, params: { cashflow: { accounting_date: @cashflow.accounting_date, balance: @cashflow.balance, month: @cashflow.month, name: @cashflow.name, user_id: @cashflow.user_id, year: @cashflow.year } }
    end
  ...
  test "should update cashflow" do
    patch cashflow_url(@cashflow), params: { cashflow: { accounting_date: @cashflow.accounting_date, balance: @cashflow.balance, month: @cashflow.month, name: @cashflow.name, user_id: @cashflow.user_id, year: @cashflow.year } }
