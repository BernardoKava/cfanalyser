class CashflowsController < ApplicationController
  ...
  # GET /cashflows.json
  def index
    @cashflows = Cashflow.all.paginate(page: params[:page], :per_page => 10).order("created_at DESC")
  end
  ...
  private
    ...
    def cashflow_params
      params.require(:cashflow).permit(:month, :year, :accounting_date, :name, :user_id, :balance)
    end
end
